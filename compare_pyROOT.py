...
# Open the root files
file1 = ROOT.TFile.Open("/afs/cern.ch/user/r/rasharma/work/aTGC/CMSSW_10_2_13/src/LHEAnalyzer/output_hadd_150to600_4f_NLO_FXFX_all_v2.root", "read")
file2 = ROOT.TFile.Open("/afs/cern.ch/user/r/rasharma/work/aTGC/CMSSW_10_2_13/src/LHEAnalyzer/output_hadd_600to800_4f_NLO_FXFX_all_v2.root", "read")
file3 = ROOT.TFile.Open("/afs/cern.ch/user/r/rasharma/work/aTGC/CMSSW_10_2_13/src/LHEAnalyzer/output_hadd_800toInf_4f_NLO_FXFX_all_v2.root", "read")
...
if InputVarToCompare == "mWHad" or InputVarToCompare == "mWLep":
    varBins = []
...
peak1 = max(max(hist1.GetMaximum(), hist2.GetMaximum()),max(hist3.GetMaximum(), hist2.GetMaximum()))
if IfnQCut:
...
c.Update()
if IfLog:
    c.SaveAs("compare_branches_"+InputVarToCompare+"_"+cut_string+"_log.pdf")
else:
    c.SaveAs("compare_branches_"+InputVarToCompare+"_"+cut_string+".pdf")
