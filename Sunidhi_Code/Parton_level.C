    ...
    for (Int_t i = 0; i < 10; i++)
    {
        ...
        for (int j = 0; j < Particle_size; j++)
        {
...

            {
                ...
                if (leptons.size() != 3)
                    isWboson1 = false;
                else if (abs(Particle_PID[momIdW1]) != 24)
                    isWboson1 = false;
                //-------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                if (abs(Particle_PID[leptons[0].index]) !=
                    ...
                    isZboson = false;
                         ...
                         Particle_Mother1[leptons[2].index])
                    isZboson = false;

                else if (Particle_PID[momIdZ_1] != 23 ||
                         Particle_PID[momIdZ_2] != 23)
                    isZboson = false;
                ...
                if (MET.size() != 1)
                    isMET = false;
                         ...
                         Particle_Mother1[leptons[0].index])
                    isMET = false;
                ...
                if (quarks.size() != 3)
                    isWboson2 = false;
                         ...
                         Particle_Mother1[quarks[2].index])
                    isWboson2 = false;

                //   else if (Particle_Mother2[quarks[1].index] !=
                //               Particle_Mother2[quarks[2].index]  )  isWboson2 = false ;

                else if (abs(Particle_PID[momIdW2_1]) != 24)
                    isWboson2 = false;
                else if (abs(Particle_PID[grandmomIdW2_1]) != 6)
                    isWboson2 = false;
                ...
                if (b_quarks.size() != 1)
                    isb_quark = false;
                else if (Particle_PID[momIdt_b] != 6)
                    isb_quark = false;
                ...
                if (!leptons.empty() && leptons.size() > 0)
                {
                    lepton1.SetPtEtaPhiE(Particle_PT[leptons[0].index], Particle_Eta[leptons[0].index], Particle_Phi[leptons[0].index], Particle_E[leptons[0].index]);
                }
                ...
                if (leptons.size() > 1)
                {
                    lepton2.SetPtEtaPhiE(Particle_PT[leptons[1].index], Particle_Eta[leptons[1].index], Particle_Phi[leptons[1].index], Particle_E[leptons[1].index]);
                }
                ...
                if (leptons.size() > 2)
                {
                    lepton3.SetPtEtaPhiE(Particle_PT[leptons[2].index], Particle_Eta[leptons[2].index], Particle_Phi[leptons[2].index], Particle_E[leptons[2].index]);
                }
                ...
                if (!quarks.empty())
                {
                    quark0.SetPtEtaPhiE(Particle_PT[quarks[0].index], Particle_Eta[quarks[0].index], Particle_Phi[quarks[0].index], Particle_E[quarks[0].index]);
                }
                ...
                if (quarks.size() > 1)
                {
                    quark1.SetPtEtaPhiE(Particle_PT[quarks[1].index], Particle_Eta[quarks[1].index], Particle_Phi[quarks[1].index], Particle_E[quarks[1].index]);
                }
                ...
                if (quarks.size() > 2)
                {
                    quark2.SetPtEtaPhiE(Particle_PT[quarks[2].index], Particle_Eta[quarks[2].index], Particle_Phi[quarks[2].index], Particle_E[quarks[2].index]);
                }
                ...
                if (!b_quarks.empty())
                    b_quark.SetPtEtaPhiE(Particle_PT[b_quarks[0].index], Particle_Eta[b_quarks[0].index], Particle_Phi[b_quarks[0].index], Particle_E[b_quarks[0].index]);
                ...
                if (!MET.empty())
                {
                    Met.SetPtEtaPhiE(Particle_PT[MET[0].index], Particle_Eta[MET[0].index], Particle_Phi[MET[0].index], Particle_E[MET[0].index]);
                }
